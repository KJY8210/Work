...
HRESULT GameScene::Initialize()
{
	...
	// 지윤
	CIngameHUD * skill = new CIngameHUD;
	m_mapGameHUD["skill"] = skill;
	m_mapGameHUD["skill"]->Initialize(L"a.png");
}
...
void GameScene::Render()
{
	...
	/*for (auto it = m_mapGameHUD.begin(); it != m_mapGameHUD.end(); ++it)
		it->second->Render();*/

	m_mapGameHUD["skill"]->Render(D3DXVECTOR3 (0, 0, 0));
}
